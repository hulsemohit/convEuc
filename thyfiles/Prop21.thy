...
proof -
	...
	have "col A E C" using col_b `axioms` `bet A E C` by blast
	...
	have "col A C A" using col_b `axioms` `A = A` by blast
	...
	have "col E D B" using col_b `axioms` `bet E D B` by blast
