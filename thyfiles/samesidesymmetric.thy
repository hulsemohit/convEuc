...
proof -
	...
	have "same_side Q P A B" using sameside_b[OF `axioms` `col A B F` `col A B E` `bet Q F G` `bet P E G` `\<not> col A B Q` `\<not> col A B P`] .
	...
	have "same_side P Q B A" using sameside_b[OF `axioms` `col B A E` `col B A F` `bet P E G` `bet Q F G` `\<not> col B A P` `\<not> col B A Q`] .
	have "same_side Q P B A" using sameside_b[OF `axioms` `col B A F` `col B A E` `bet Q F G` `bet P E G` `\<not> col B A Q` `\<not> col B A P`] .
