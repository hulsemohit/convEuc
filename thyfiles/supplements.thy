...
proof -
	have "bet A B F" sorry
	have "ray_on B C D" sorry
	have "bet a b f" sorry
	have "ray_on b c d" sorry
	...
	proof (rule ccontr)
		...
		have "col A B F" using col_b `axioms` `bet A B F` by blast
