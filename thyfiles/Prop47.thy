...
proof -
	...
	have "col E l D" using col_b `axioms` `parallelogram C m l E \<and> bet C m B \<and> parallelogram m B D l \<and> bet E l D \<and> bet l m A \<and> ang_right E l A \<and> qua_eq_area A C K H C m l E` by blast
	have "col D L E" using col_b `axioms` `parallelogram B M L D \<and> bet B M C \<and> parallelogram M C E L \<and> bet D L E \<and> bet L M A \<and> ang_right D L A \<and> qua_eq_area A B F G B M L D` by blast
	...
	have "col L m A" using col_b `axioms` `bet L m A` by blast
	have "col L M A" using col_b `axioms` `parallelogram B M L D \<and> bet B M C \<and> parallelogram M C E L \<and> bet D L E \<and> bet L M A \<and> ang_right D L A \<and> qua_eq_area A B F G B M L D` by blast
	...
	have "col B M C" using col_b `axioms` `parallelogram B M L D \<and> bet B M C \<and> parallelogram M C E L \<and> bet D L E \<and> bet L M A \<and> ang_right D L A \<and> qua_eq_area A B F G B M L D` by blast
	have "col C B M" using collinearorder[OF `axioms` `col B M C`] by blast
	have "col C m B" using col_b `axioms` `parallelogram C m l E \<and> bet C m B \<and> parallelogram m B D l \<and> bet E l D \<and> bet l m A \<and> ang_right E l A \<and> qua_eq_area A C K H C m l E` by blast
	...
	qed
	hence "M = m" by blast
	have "qua_eq_area A C K H C M l E" sorry
	have "qua_eq_area A C K H C M L E" sorry
