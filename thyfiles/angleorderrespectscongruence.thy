...
proof -
	obtain G H J where "bet G H J \<and> ray_on E D G \<and> ray_on E F J \<and> ang_eq A B C D E H" sorry
	...
	proof (rule ccontr)
		assume "G = E"
		have "col G H E" using col_b `axioms` `G = E` by blast
	...
	proof (rule ccontr)
		assume "Q = W"
		have "col Q U W" using col_b `axioms` `Q = W` by blast
