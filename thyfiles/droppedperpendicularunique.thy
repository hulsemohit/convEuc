...
proof -
	...
	proof (rule ccontr)
		...
		obtain E where "bet M J E \<and> seg_eq J E M J" sorry
		have "bet M J E" using `bet M J E \<and> seg_eq J E M J` by simp
		have "M \<noteq> E" using betweennotequal[OF `axioms` `bet M J E`] by blast
		obtain F where "bet J M F \<and> seg_eq M F M E" sorry
		have "seg_eq M F M E" using `bet J M F \<and> seg_eq M F M E` by simp
		have "bet J M F" using `bet J M F \<and> seg_eq M F M E` by simp
