...
hence "col S Q T" by blast
	...
	have "triangle S Q T" using triangle_b[OF `axioms` `\<not> col S Q T`] .
	...
	have "ang_lt A B C P Q R" using anglelessthan_b[OF `axioms` `bet U K V` `ray_on Q P U` `ray_on Q R V` `ang_eq A B C P Q K`] .
