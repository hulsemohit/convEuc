...
proof -
	...
	obtain a b e where "col A B a \<and> col A B b \<and> bet C a e \<and> bet D b e \<and> \<not> col A B C \<and> \<not> col A B D" sorry
	...
	have "col C a e" using col_b `axioms` `col A B a \<and> col A B b \<and> bet C a e \<and> bet D b e \<and> \<not> col A B C \<and> \<not> col A B D` by blast
	have "col D b e" using col_b `axioms` `col A B a \<and> col A B b \<and> bet C a e \<and> bet D b e \<and> \<not> col A B C \<and> \<not> col A B D` by blast
