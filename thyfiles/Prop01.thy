...
proof -
	obtain J where "circle J A A B" sorry
	obtain K where "circle K B A B" sorry
	...
	have "circle K B A B \<and> cir_ou D K" sorry
	...
	proof (rule ccontr)
		...
		have "seg_eq C A A C" using equalityreverseE[OF `axioms`] .
