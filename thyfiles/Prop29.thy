...
proof -
	have "col C H D" using col_b `axioms` `bet C H D` by blast
	...
	obtain R where "bet A R D \<and> col G H R \<and> \<not> col G H A" sorry
	have "oppo_side D G H A" using oppositesidesymmetric[OF `axioms` `oppo_side A G H D`] .
	have "\<not> col G H D" sorry
	...
	have "col D H H" using col_b `axioms` `H = H` by blast
	...
	have "col C H C" using col_b `axioms` `C = C` by blast
	...
	have "col G S H" using col_b `axioms` `bet P G Q \<and> ang_eq Q G H G H C \<and> ang_eq Q G H C H G \<and> ang_eq H G Q C H G \<and> ang_eq P G H G H D \<and> ang_eq P G H D H G \<and> ang_eq H G P D H G \<and> parallel P Q C D \<and> seg_eq P G H D \<and> seg_eq G Q C H \<and> seg_eq G S S H \<and> seg_eq P S S D \<and> seg_eq C S S Q \<and> bet P S D \<and> bet C S Q \<and> bet G S H` by blast
	...
	proof (rule ccontr)
		...
		have "col G M K" using col_b `axioms` `bet G M K \<and> bet D H K` by blast
		...
		have "col H D K" using col_b `axioms` `bet G M K \<and> bet D H K` by blast
	...
	proof (rule ccontr)
		...
		have "linear_pair P G H H Q" sorry
		...
		have "linear_pair D H G G C" sorry
		...
		obtain L where "bet P L B \<and> col G H L \<and> \<not> col G H P" sorry
		...
		have "col G M K" using col_b `axioms` `bet G M K \<and> bet C H K` by blast
		...
		have "col B G A" using col_b `axioms` `bet B G A` by blast
		...
		have "col H C K" using col_b `axioms` `bet G M K \<and> bet C H K` by blast
	...
	have "ang_suppl B G H G H D" sorry
