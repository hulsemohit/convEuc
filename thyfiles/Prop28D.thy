...
proof -
	...
	have "col D H C" using col_b `axioms` `bet D H C \<and> seg_eq H C H D` by blast
	...
	have "col B G A" using col_b `axioms` `bet B G A \<and> seg_eq G A G B` by blast
