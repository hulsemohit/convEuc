...
proof -
	...
	obtain a b c d e where "linear_pair a b c e d \<and> ang_eq B G H a b c \<and> ang_eq G H D e b d" using tworightangles_f[OF `axioms` `ang_suppl B G H G H D`] by blast
