...
proof -
	...
	have "oppo_side A C D E" sorry
	have "oppo_side B C D E" using planeseparation[OF `axioms` `same_side B A C D` `oppo_side A C D E`] .
	obtain H where "bet B H E \<and> col C D H \<and> \<not> col C D B" sorry
	...
	proof (rule ccontr)
		...
		obtain p where "E \<noteq> D \<and> C \<noteq> B \<and> col E D p \<and> col C B p" sorry
