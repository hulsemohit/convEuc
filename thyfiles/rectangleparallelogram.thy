...
proof -
	...
	proof (rule ccontr)
		...
		obtain P where "A \<noteq> B \<and> C \<noteq> D \<and> col A B P \<and> col C D P" sorry
	...
	proof (rule ccontr)
		...
		obtain P where "A \<noteq> D \<and> B \<noteq> C \<and> col A D P \<and> col B C P" sorry
