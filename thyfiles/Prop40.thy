...
proof -
	...
	have "col P D Q" using col_b `axioms` `bet P D Q \<and> ang_eq P D H D H E \<and> parallel P Q R E \<and> bet P M E \<and> bet D M H` by blast
