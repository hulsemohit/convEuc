...
proof -
	...
	obtain p q r s t where "linear_pair p q r s t \<and> ang_eq C A B p q r \<and> ang_eq A B D s q t" using tworightangles_f[OF `axioms` `ang_suppl C A B A B D`] by blast
