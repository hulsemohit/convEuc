...
proof -
	obtain C where "bet A M C \<and> seg_eq A M C M \<and> seg_eq A P C P \<and> M \<noteq> P" sorry
	...
	have "ang_right C M P" sorry
	have "ang_right P M A" using n8_2[OF `axioms` `ang_right A M P`] .
	obtain Q where "bet P M Q \<and> seg_eq P M Q M \<and> seg_eq P A Q A \<and> M \<noteq> A" sorry
	...
	have "ray_on M C B" sorry
	have "ang_right P M B" using n8_3[OF `axioms` `ang_right P M C` `ray_on M C B`] .
	obtain E where "bet P M E \<and> seg_eq P M E M \<and> seg_eq P B E B \<and> M \<noteq> B" sorry
	...
	proof (rule ccontr)
		assume "A = P"
		have "col A P M" using col_b `axioms` `A = P` by blast
