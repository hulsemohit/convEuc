...
proof -
	...
	obtain K where "cir_on K L \<and> cir_on K R" using circle_circleE[OF `axioms` `circle L F A a` `cir_in N L` `cir_ou H L` `circle R G C c` `cir_on N R` `cir_on H R`]  by  blast
