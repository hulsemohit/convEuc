...
const std::map<std::string, theorem> axioms{
    ...
    {"5-line",
     theorem({"EEBCbc", "EEADad", "EEBDbd", "BEABC", "BEabc", "EEABab"},
             "EEDCdc")},
    ...
    {"line-circle",
     theorem({"CIKCPQ", "ICBK", "NEAB"}, "ANCOABX+COABY+ONXK+ONYK+BEXBY")},
    {"circle-circle",
     theorem({"CIJCRS", "ICPJ", "OCQJ", "CIKDFG", "ONPK", "ONQK"},
             "ANONXJ+ONXK")},
    {"Euclid5",
     theorem({"BErts", "BEptq", "BEraq", "EEptqt", "EEtrts"}, "ANBEpaX+BEsqX")},

    // additional axioms
    {"congruentequal", theorem({"TCABCabc"}, "ETABCabc")},
    {"ETpermutation",
     theorem({"ETABCabc"}, "ANETABCbca+ETABCacb+ETABCbac+ETABCcba+ETABCcab")},
    {"ETsymmetric", theorem({"ETABCabc"}, "ETabcABC")},
    {"EFpermutation",
     theorem({"EFABCDabcd"}, "ANEFABCDbcda+EFABCDdcba+EFABCDcdab+EFABCDbadc+"
                             "EFABCDdabc+EFABCDcbad+EFABCDadcb")},
    {"halvesofequals",
     theorem({"ETABCBCD", "OSABCD", "ETabcbcd", "OSabcd", "EFABDCabdc"},
             "ETABCabc")},
    ...
    {"cutoff1",
     theorem({"BEABC", "BEabc", "BEEDC", "BEedc", "ETBCDbcd", "ETACEace"},
             "EFABDEabde")},
    {"cutoff2",
     theorem({"BEBCD", "BEbcd", "ETCDEcde", "EFABDEabde"}, "EFABCEabce")},
    {"paste1",
     theorem({"BEABC", "BEabc", "BEEDC", "BEedc", "ETBCDbcd", "EFABDEabde"},
             "ETACEace")},
    {"deZolt1", theorem({"BEBED"}, "NOETDBCEBC")},
    {"deZolt2", theorem({"TRABC", "BEBEA", "BEBFC"}, "NOETABCEBF")},
    {"paste2", theorem({"BEBCD", "BEbcd", "ETCDEcde", "EFABCEabce", "BEAMD",
                        "BEBME", "BEamd", "BEbme"},
                       "EFABDEabde")},
    {"paste3", theorem({"ETABCabc", "ETABDabd", "BECMD", "ORBEAMB|EQAM|EQMB",
                        "BEcmd", "ORBEamb|EQam|EQmb"},
                       "EFACBDacbd")},
    {"paste4", theorem({"EFABmDFKHG", "EFDBeCGHML", "BEAPC", "BEBPD", "BEKHM",
                        "BEFGL", "BEBmD", "BEBeC", "BEFJM", "BEKJL"},
                       "EFABCDFKML")},
};
