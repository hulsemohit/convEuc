...
const std::vector<std::pair<std::string, theorem>> def_list{
    ...
    {"inside_f",
     theorem({"CIJCAB", "ICPJ"}, "ANCIJCAB+BEXCY+EECYAB+EECXAB+BEXPY")},
    {"inside_b", theorem({"CIJCAB", "BEXCY", "EECYAB", "EECXAB", "BEXPY"},
                         "ANCIJCAB+ICPJ")},
    ...
    {"equalangles_f",
     theorem({"EAABCabc"},
             "ANRABAU+RABCV+RAbau+RAbcv+EEBUbu+EEBVbv+EEUVuv+NCABC")},
    {"equalangles_b", theorem({"RABAU", "RABCV", "RAbau", "RAbcv", "EEBUbu",
                               "EEBVbv", "EEUVuv", "NCABC"},
                              "EAABCabc")},
    ...
    {"sameside_f",
     theorem({"SSPQAB"}, "ANCOABU+COABV+BEPUX+BEQVX+NCABP+NCABQ")},
    {"sameside_b",
     theorem({"COABU", "COABV", "BEPUX", "BEQVX", "NCABP", "NCABQ"}, "SSPQAB")},
    ...
    {"trianglecongruence_f",
     theorem({"TCABCabc"}, "ANEEABab+EEBCbc+EEACac+TRABC")},
    {"trianglecongruence_b",
     theorem({"EEABab", "EEBCbc", "EEACac", "TRABC"}, "TCABCabc")},

    {"anglelessthan_f", theorem({"AOABCDEF"}, "ANBEUXV+RAEDU+RAEFV+EAABCDEX")},
    {"anglelessthan_b",
     theorem({"BEUXV", "RAEDU", "RAEFV", "EAABCDEX"}, "AOABCDEF")},
    ...
    {"tworightangles_b",
     theorem({"SUXYUVZ", "EAABCXYU", "EADEFVYZ"}, "RTABCDEF")},
    ...
    {"tarski_parallel_b",
     theorem({"NEAB", "NECD", "NOMEABCD", "SSCDAB"}, "TPABCD")},

    {"parallel_f",
     theorem(
         {"PRABCD"},
         "ANNEAB+NECD+COABU+COABV+NEUV+COCDu+COCDv+NEuv+NOMEABCD+BEUXv+BEuXV")},
    {"parallel_b", theorem({"NEAB", "NECD", "COABU", "COABV", "NEUV", "COCDu",
                            "COCDv", "NEuv", "NOMEABCD", "BEUXv", "BEuXV"},
                           "PRABCD")},
    ...
    {"square_f",
     theorem({"SQABCD"}, "ANEEABCD+EEABBC+EEABDA+RRDAB+RRABC+RRBCD+RRCDA")},
    {"square_b",
     theorem({"EEABCD", "EEABBC", "EEABDA", "RRDAB", "RRABC", "RRBCD", "RRCDA"},
             "SQABCD")},

    {"rectangle_f", theorem({"REABCD"}, "ANRRDAB+RRABC+RRBCD+RRCDA+CRACBD")},
    {"rectangle_b",
     theorem({"RRDAB", "RRABC", "RRBCD", "RRCDA", "CRACBD"}, "REABCD")},

    {"congruentrectangles_f",
     theorem({"RCABCDabcd"}, "ANREABCD+REabcd+EEABab+EEBCbc")},
    {"congruentrectangles_b",
     theorem({"REABCD", "REabcd", "EEABab", "EEBCbc"}, "RCABCDabcd")},

    {"equalrectangles_f",
     theorem({"ERABCDabcd"}, "ANRCABCDXYZU+RCabcdxYzu+BExYZ+BEXYz+BEWUw")},
    {"equalrectangles_b",
     theorem({"RCABCDXYZU", "RCabcdxYzu", "BExYZ", "BEXYz", "BEWUw"},
             "ERABCDabcd")},
    ...
    {"figurerectangle_f",
     theorem({"FRABCDEFGH"}, "ANREEFGH+BEEBF+BEHDG+BRCBDGF+BRABDHE")},
    {"figurerectangle_b",
     theorem({"REEFGH", "BEEBF", "BEHDG", "BRCBDGF", "BRABDHE"}, "FRABCDEFGH")},

    {"equaltriangles_f",
     theorem({"TEABCabc"}, "ANREABXY+REabxy+COXYC+COxyc+ERABXYabxy")},
    {"equaltriangles_b",
     theorem({"REABXY", "REabxy", "COXYC", "COxyc", "ERABXYabxy"}, "TEABCabc")},

    {"equalfigures_f",
     theorem({"FEABCDabcd"},
             "ANOSABCD+OSabcd+FRABCDXYZU+FRabcdxyzu+ERXYZUxyzu")},
    {"equalfigures_b",
     theorem({"OSABCD", "OSabcd", "FRABCDXYZU", "FRabcdxyzu", "ERXYZUxyzu"},
             "FEABCDabcd")},
    /*
        {"equaltrianglefigure_f", theorem({"TFABCabcd"},
       "ANBRABCXY+FRabcdxyzu+ERBCXYxyzu")},
        {"equaltrianglefigure_b", theorem({"BRABCXY", "FRabcdxyzu",
       "ERBCXYxyzu"}, "TFABCabcd")},
    */
};

const std::map<std::string, theorem> definitions(def_list.begin(),
                                                 def_list.end());
